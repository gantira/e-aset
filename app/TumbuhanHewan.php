...
class TumbuhanHewan extends Model
{
    protected $fillable = [
    	'user_id',  'kode_tumbuhanhewan', 'nama_tumbuhanhewan', 'nomor_register', 'jenis_tumbuhanhewan', 'ukuran', 'jumlah', 'asal_usul', 'tanggal', 'harga', 'keterangan', 'komentar', 'created_at'
    ];

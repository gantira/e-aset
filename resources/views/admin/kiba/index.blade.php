...
@section('content')
	<div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
		           		@forelse ($kiba as $row)
		           			<li><a href="{{ url('admin/kiba/needapprove/'.$row->user_id) }}">{{ $row->profile->nama_sekolah }} (<i>{{ $row->whereUserId($row->user_id)->whereStatus(1)->count() }}</i>)</a></li>
		           		@empty
		...
		<div id="myComment" class="modal fade" role="dialog">
		  <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        {{ Form::open(['url'=>'admin/kiba/ignore', 'method'=>'post']) }}

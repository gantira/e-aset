            ...
            <div class="row">
                <div class="col-lg-12">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="{{ asset('doc/kibb.xls') }}">Format Dokumen</a></li>
								...
								<table class="table table-hover table-bordered" id="dataTables">
									...
									@foreach($user->kibb as $row)
										<tr style="background-color: {{ $row->status == 'Ignored' ? '#fffae5': '' }}">
											...
											<td><a href="{{ url('kibb/edit/'.$row->id) }}">Edit</a> | <a href="{{ url('kibb/delete/'.$row->id) }}">Delete</a></td>
										</tr>
									@endforeach
									</tbody>
								</table>
		...
		<div id="myUpload" class="modal fade" role="dialog">
		  <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
		        <h4 class="modal-title">Upload Dokumen Kib B</h4>
		      </div>
		      <div class="modal-body">
		      	{{ Form::open(['url'=>'kibb/upload', 'files' => true]) }}
		        	{{ Form::file('xls') }}
		        	<br>
